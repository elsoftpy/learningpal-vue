...
return [
    ...
    'hex_color' => 'O campo :attribute deve ser um cor hexadecimal válido.',
    ...
    'attributes' => [
        ...
        'course_id' => 'curso',
        'language_id' => 'idioma',
        'language_level_id' => 'nível de idioma',
        'teacher_id' => 'teacher',
        ...
        'rescheduled_date' => 'data reagendada',
        'rescheduled_start_time' => 'hora de início reagendada',
        'rescheduled_end_time' => 'hora de término reagendada',
        'week_number' => 'número da semana',
        'level_content_id' => 'conteúdo do nível',
        'class_schedule_detail_id' => 'detalhe do horário da aula',
        'duration_minutes' => 'duração (minutos)',
        'chat_room_link' => 'link da sala de chat',
        'schedule_month' => 'mês do horário',
        ...
        'detail_files' => 'arquivos de detalhe',
        'details' => 'detalhes',
        'free_content' => 'conteúdo livre',
        'from_date' => 'data inicial',
        'level' => 'nível',
        'links' => 'links',
        'month' => 'mês',
        'month_end_date' => 'data final do mês',
        'month_start_date' => 'data inicial do mês',
        'page' => 'página',
        'per_page' => 'itens por página',
        'selected_row_ids' => 'ids das linhas selecionadas',
        'sort_field' => 'campo de ordenação',
        'sort_order' => 'ordem de classificação',
        'student_attendances' => 'presenças de estudantes',
        'student_production_audio' => 'áudio de produção do estudante',
        'student_production_file' => 'arquivo de produção do estudante',
