...
return [
    ...
    'attributes' => [
        ...
        'course_id' => 'curso',
        'language_id' => 'idioma',
        'language_level_id' => 'nivel de idioma',
        'teacher_id' => 'teacher',
        ...
        'rescheduled_date' => 'fecha reprogramada',
        'rescheduled_start_time' => 'hora de inicio reprogramada',
        'rescheduled_end_time' => 'hora de fin reprogramada',
        'week_number' => 'número de semana',
        'level_content_id' => 'contenido de nivel',
        'class_schedule_detail_id' => 'detalle del horario de clase',
        'duration_minutes' => 'duración (minutos)',
        'chat_room_link' => 'enlace de sala de chat',
        'schedule_month' => 'mes de horario',
        ...
        'detail_files' => 'archivos de detalle',
        'details' => 'detalles',
        ...
        'links' => 'enlaces',
        'month' => 'mes',
        'month_end_date' => 'fecha de fin de mes',
        'month_start_date' => 'fecha de inicio de mes',
        'page' => 'página',
        'per_page' => 'elementos por página',
        'selected_row_ids' => 'ids de filas seleccionadas',
        'sort_field' => 'campo de ordenamiento',
        'sort_order' => 'orden de clasificación',
        'student_attendances' => 'asistencias de estudiantes',
        'student_production_audio' => 'audio de producción del estudiante',
        'student_production_file' => 'archivo de producción del estudiante',
