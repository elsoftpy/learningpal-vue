...
class ClassScheduleDetailSpaTest extends TestCase
{
    ...
    public function test_rescheduling_a_session_leaves_it_pending_instead_of_reprogramed(): void
    {
        $user = User::factory()->create();
        ...
        $this->assertSame(ClassScheduleStatusEnum::PENDING->value, $detail->status);
