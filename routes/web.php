...
Route::prefix('settings')->name('settings.')->middleware(['spa.navigation', 'auth'])->group(function () {
...
Route::prefix('academics')->name('academics.')->middleware(['spa.navigation', 'auth'])->group(function () {
    ...
    Route::prefix('lessons')->name('lessons.')->group(function () {
        Route::prefix('class-schedules')->name('class-schedules.')->group(function () {
            ...
            Route::prefix('details')->name('details.')->group(function () {
                ...
                Route::post('/{detail}/status', [ClassScheduleDetailController::class, 'updateStatus'])
                    ->name('status');
