...
@php
    ...
    $doneMessage = $doneMessage ?? session('done_message');
@endphp
...
<div class="w-full max-w-2xl">
    <div class="bg-white border border-slate-200 rounded-lg shadow-sm p-8 text-center">
        ...
        @elseif ($doneStatus === 'unavailable')
            ...
            <p class="text-slate-600">
                {{ $doneMessage ?: __('This session cannot be modified at this time.') }}
            </p>
            <p class="text-slate-600 mt-3">
                {{ __('Pending is available up to 1 hour before session start, and upload task is available up to 10 minutes before session end.') }}
            </p>
