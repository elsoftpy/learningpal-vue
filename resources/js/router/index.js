...
const routes = [
  ...
  {
    path: '/academics/settings/level-contents',
    name: 'academics.settings.level-contents.list',
    component: () => import('../Pages/academics/settings/level-contents/LevelContentsListPage.vue'),
    meta: { 
      requiresAuth: true,
      module: 'academics', 
      submodule: 'settings', 
      title: 'Level Contents List',
      headerIcon: 'list',
      crud: 'read',
    },
  },
  {
    path: '/academics/settings/level-contents/create',
    name: 'academics.settings.level-contents.create',
    component: () => import('../Pages/academics/settings/level-contents/LevelContentFormPage.vue'),
    meta: { 
      requiresAuth: true,
      module: 'academics', 
      submodule: 'settings', 
      title: 'Add Level Content',
      headerIcon: 'plus',
      crud: 'create',
    },
  },
  {
    path: '/academics/settings/level-contents/:id/data',
    name: 'academics.settings.level-contents.edit',
    component: () => import('../Pages/academics/settings/level-contents/LevelContentFormPage.vue'),
    meta: { 
      requiresAuth: true,
      module: 'academics', 
